    ...
    return (
        <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg">
            <div className="flex flex-col items-center text-center">
                <h1 className="text-xl font-bold text-dark-700 mb-2">Guard Added Successfully</h1>
                <p className="text-base text-gray-700 mb-6">
                    Your guard has been successfully created. However, it needs to be approved by an administrator
