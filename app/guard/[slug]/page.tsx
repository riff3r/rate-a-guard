            ...
            <div className="flex gap-10">
                <div className="w-4/12">
                    ...
                    <div className="flex items-center gap-2 my-5">
                        <h1 className=" font-poppins text-5xl font-black">Ashley Moraguez</h1>
                        <Bookmark />
                    </div>
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-2">
                            <Button className="rounded-full font-extrabold" variant={"secondary"} size={"default"}>
                                Get ready to read
                            </Button>
                            <Button className="rounded-full font-extrabold" variant={"secondary"} size={"default"}>
                                Tough grader
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex gap-2 p-5 bg-primary-foreground">
                        <div className="flex gap-5">
                            ...
                            <div>
                                Moraguez is such a nice person! She&apos;s interested in students learning the material,
                                she&apos;s willing to answer questions about the material in class. She&apos;s young, so
                                she understands that this is not the only class her students take. Really enjoyed her,
                                would highly recommend this class to anyone that enjoys American politics.
                            </div>
                        </div>
                    </div>
                    <div className="flex gap-2 p-5 bg-primary-foreground">
