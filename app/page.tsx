      ...
      <section className="bg-gray-50 py-16 px-4 text-center relative">
        ...
        <div className="max-w-3xl mx-auto bg-white bg-opacity-75 p-8 rounded-lg z-20 relative">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Welcome to RateAGuard.com, your trusted platform for finding reviews
            about guards and security companies. Join us in creating a more
            transparent and efficient security workforce.
          </p>
